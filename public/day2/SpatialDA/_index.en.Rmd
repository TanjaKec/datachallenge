...
`Leaflet` is one of the most popular open-source JavaScript libraries for interactive maps that was integrated into R, by team of people from RStudio. We will illustrate how easy it is to plot a location map using leaflet package, butyou can learn more about this package from [Leaflet for R](https://rstudio.github.io/leaflet/) website.
